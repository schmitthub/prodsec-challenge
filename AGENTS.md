...
semgrep --test --config "$PWD/.semgrep/fastapi-access-control.yaml" "$PWD/.semgrep/fastapi-access-control.py"  # rule fixture (absolute paths; 1.175 trips on relative ones)
