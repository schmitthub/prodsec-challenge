...
prek run semgrep-rule-tests --all-files        # `semgrep --test` of every .semgrep/<name>.yaml against its sibling fixture (.github/scripts/semgrep_test.py; runs on commit when .semgrep/ changes)
