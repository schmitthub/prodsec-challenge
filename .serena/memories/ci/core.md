...
- `security.yml` (gating policy in header comment):
  ...
  - `osv`: nested reusable `google/osv-scanner-action/.github/workflows/osv-scanner-reusable.yml`, `scan-args: -L requirements.txt`, `fail-on-vuln: false`.
