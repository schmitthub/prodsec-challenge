...
- **Seeded cases**: `evals/cases.md` lists the eleven seeded defects with owning class and eight expected non-detections (`/me`, `/notes`, staff gate, fixtures, `test.yml`, pinned actions, advisory-scan topology). Never reviewer input. Run on `../../app/api/routes/` 2026-09-02: all in-scope seeds found and verified, no non-detection survived.
