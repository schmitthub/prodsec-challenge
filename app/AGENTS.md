...
`app` is the service's runtime package: `main.py` assembles the ASGI application, while `auth.py`, `db.py`, and `models.py` provide shared dependencies used by the route modules.
